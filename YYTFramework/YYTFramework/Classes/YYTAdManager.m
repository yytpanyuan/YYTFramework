...
- (void) startGoogleBannerAd
{
    ...
    _googleBannerView.adUnitID = kGoogleAdUnitID;
    _googleBannerView.backgroundColor = [UIColor clearColor];
    _googleBannerView.rootViewController = kAppDelegate.rootController;
    CGRect rect = [UIScreen mainScreen].bounds;
    _googleBannerView.frame = CGRectMake(0, rect.size.height-kAdBarHeight-kTabBarHeight, rect.size.width, kAdBarHeight);
    ...
    [kAppDelegate.rootController.view addSubview:_googleBannerView];
}
...
- (void) startBaiduBannerAd
{
    ...
    _baiduBannerView.AdUnitTag = kBaiduBannerID;
    _baiduBannerView.AdType = BaiduMobAdViewTypeBanner;
    CGRect rect = [UIScreen mainScreen].bounds;
    _baiduBannerView.frame = CGRectMake(0, rect.size.height-kAdBarHeight-kTabBarHeight, rect.size.width, kAdBarHeight);
    [kAppDelegate.rootController.view addSubview:_baiduBannerView];
